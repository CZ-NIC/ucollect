...
struct mem_pool *mem_pool_create(const char *name) __attribute__((malloc)) __attribute__((returns_nonnull));
...
void *mem_pool_alloc(struct mem_pool *pool, size_t size) __attribute__((malloc)) __attribute__((nonnull)) __attribute__((alloc_size(2))) __attribute__((returns_nonnull));
...
char *mem_pool_strdup(struct mem_pool *pool, const char *string) __attribute__((malloc)) __attribute__((nonnull)) __attribute__((returns_nonnull));
// Format a string by printf formatting to memory from the pool and return
char *mem_pool_printf(struct mem_pool *pool, const char *format, ...) __attribute__((malloc)) __attribute__((nonnull(1, 2))) __attribute__((format(printf, 2, 3))) __attribute__((returns_nonnull));
