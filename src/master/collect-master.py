...
args = ['socat', 'OPENSSL-LISTEN:' + str(master_config.getint('port')) + ',fork,backlog=50,key=' + master_config.get('key') + ',cert=' + master_config.get('cert') + ',verify=0,cipher=HIGH:!MEDIUM:!LOW:!aNULL,reuseaddr,pf=ip6,compress=auto,method=TLS', 'UNIX-CONNECT:./collect-master.sock']
